...
## Key Features
- Interactive charts and maps embedded in a narrative webpage
- Clear section-based storytelling (introduction → evidence → takeaway)
- Responsive layout and custom typography/styling
- Reproducible data-to-viz workflow (data preparation + visualization code)

## Tech Stack
- **Frontend:** HTML / CSS / JavaScript
- **Visualization:** (Altair / Vega-Lite / D3 / Tableau embeds — *edit to match your project*)
- **Data processing:** Python (pandas) / Jupyter Notebook (*if applicable*)
